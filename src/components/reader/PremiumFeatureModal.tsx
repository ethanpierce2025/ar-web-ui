...
export type PremiumFeatureModalProps = Pick<DialogProps<any>, 'open' | 'onClose'> & {
  feature: string;
};

export const PremiumFeatureModal: FunctionComponent<PremiumFeatureModalProps> = (props) => {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                  <p className="text-m font-primary">
                    {feature} requires a School License. This premium feature is exclusively available through our
                    School License program.
                  </p>
                </div>
